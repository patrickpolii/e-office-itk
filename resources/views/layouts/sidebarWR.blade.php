<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="{{ route('wrektor.dashboard') }}"><em class="fa fa-home">&nbsp;</em> Dashboard </a></li>
        <li class="parent "><a data-toggle="collapse" href="#">
            ...
            <ul class="children collapse" id="sub-item-1">
                <li><a class="" href="{{ route('wrektor.pengajuan') }}">
                    <span class="fa fa-arrow-right">&nbsp;</span> Pengajuan
                </a></li>
                <li><a class="" href="{{ route('wrektor.ttd') }}">
                    <span class="fa fa-arrow-right">&nbsp;</span> Ditandatangani
                </a></li>
                <li><a class="" href="{{ route('wrektor.paraf') }}">
                    <span class="fa fa-arrow-right">&nbsp;</span> Paraf
                </a></li>
                <li><a class="" href="{{ route('wrektor.tolak') }}">
