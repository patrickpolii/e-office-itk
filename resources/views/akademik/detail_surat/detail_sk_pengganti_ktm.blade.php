...
<div class="card">
    <div class="card-body">
        <h2><center>Detail Surat Keterangan Pengganti KTM</center></h2>
        ...
        <div class="form-group">
            <label for="keperluan">KEPERLUAN</label><br>
                <input type="text" name="keperluan" value="{{$surat->sk_pengganti_ktm->keperluan}}" class="form-control" readonly>
        </div>
        <div class="form-row">
            ...
            <form action="{{ route('cetak.surat', $surat->id) }}" method="PUT" enctype="multipart/form-data">
            @csrf
            <div class="form-group col-md-6">
        ...
        <div class="row">
            ...
            @elseif ($surat->status_surat == 2)
                <div class="col-sm-8">
                    <a href={{route('akademik.cetak')}} class="btn btn-primary"><b><- Kembali</b></a>
                </div>
                <div class="col-sm-2">
            ...
            @elseif ($surat->status_surat == 4)
                <div class="col-sm-8">
                    <a href={{route('akademik.diteruskan')}} class="btn btn-primary"><b><- Kembali</b></a>
                </div>
            @endif      
        </div>
    </div>
