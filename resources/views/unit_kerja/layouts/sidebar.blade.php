<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="{{ url('/jurusan/dashboard') }}"><em class="fa fa-home">&nbsp;</em> Dashboard </a></li>
        <li class="parent "><a data-toggle="collapse" href="#">
            ...
            <ul class="children collapse" id="sub-item-1">
                <li><a class="" href="{{ route('jurusan.pengajuan') }}">
                    <span class="fa fa-arrow-right">&nbsp;</span> Pengajuan
                </a></li>
                <li><a class="" href="{{ route('jurusan.verifikasi') }}">
                    <span class="fa fa-arrow-right">&nbsp;</span> Terverivikasi
                </a></li>
                <li><a class="" href="{{ route('jurusan.cetak') }}">
                    <span class="fa fa-arrow-right">&nbsp;</span> Cetak
                </a></li>
                <li><a class="" href="{{ route('jurusan.tolak') }}">
